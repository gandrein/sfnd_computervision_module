...
void evalTTC(LidarTtcMethod lidarTtcMethod, DataFrame &currFrame, DataFrame &prevFrame, cv::Mat &P_rect_00,
             cv::Mat &R_rect_00, cv::Mat &RT, double sensorFrameRate, bool visualize) {
