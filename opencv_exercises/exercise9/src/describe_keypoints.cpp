...
void descKeypoints1() {
  ...
  // Exercise Assignment: Add the SIFT detector / descriptor, compute the time for both steps
  // and compare both BRISK and SIFT with regard to processing speed and the number and
