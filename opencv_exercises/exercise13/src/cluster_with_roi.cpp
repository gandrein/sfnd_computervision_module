...
void clusterLidarWithROI(std::vector<BoundingBox> &boundingBoxes, std::vector<LidarPoint> &lidarPoints) {
  ...
  // show results
  // overlay lidar points on top of image
  float opacity = 0.6;
...
int main() {
  ...
  readLidarPts("../data/C53A3_currLidarPts.dat", lidarPoints);

  std::vector<BoundingBox> boundingBoxes;
  readBoundingBoxes("../data/C53A3_currBoundingBoxes.dat", boundingBoxes);
